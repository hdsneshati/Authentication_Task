import 'package:authentication_task/config/extentions/context_extentions.dart';
...
/*این فایل DioErrorHandler عملاً یک ماژول متمرکز برای مدیریت پیام‌های خطا هست که وقتی با کتابخانه dio درخواست‌های HTTP می‌زنی، به جای اینکه توی هر جای کد جداگانه خطا رو مدیریت کنی، بیاریش توی یک تابع مرکزی و پیام مناسب کاربر رو بده.
